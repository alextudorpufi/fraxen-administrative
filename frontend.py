...
def get_ranked_data(query_list, sectors):
    ...
    for e in execs:
        ...
        content_blobs = [
            ...
            " ".join(e_sectors), # Now safely joined
...
# # Apply result cap
# # No need for now for pagination, but we can easily slice the ranked list to limit results shown
# ranked_execs = ranked_execs[:max_results]
